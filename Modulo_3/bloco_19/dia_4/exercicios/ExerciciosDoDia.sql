...
-- 6  Exclua da tabela Movies o filme "WALL-E". P.S.: Lembrando que existe uma relação de Primary key-Foreign Key,
-- portanto devemos excluir primeiro a referencia da tabela BoxOffice, para depois exluir da tabela Movies.
