...
-- Porém, não inclua o cliente KENNETH no resultado. Solução:
...
SELECT COUNT(`active`) AS total_clientes_ativos FROM sakila.customer
...
-- para que possamos fazer uma divulgação melhor desses filmes. Em caso de empate, ordene em ordem alfabética pelo título. Solução:
