...
-- hicks, crawford, henry, boyd, mason, morales e kennedy , ordenados por nome em ordem alfabética. Solução:
...
-- diferente do formato brasileiro, que é dia/mês/ano . Solução:
SELECT COUNT(*) AS totol_pagamentos FROM sakila.payment
...
-- Em caso de empate, ordene em ordem alfabética pelo título. Solução:
...
-- classificações indicativas G, PG e PG-13 . Os resultados devem estar ordenados por título. Solução:
