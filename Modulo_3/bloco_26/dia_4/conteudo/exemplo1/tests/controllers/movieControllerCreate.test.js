const sinon = require('sinon'); // o espião que vai colocar o stud "duble" em ação
const { expect } = require('chai');


const MoviesService = require('../../services/movieService'); // camada a ser Mockada
const MoviesController = require('../../controllers/movieController'); // camada a ser testada
